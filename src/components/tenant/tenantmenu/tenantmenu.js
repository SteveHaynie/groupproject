...
class TenantMenu extends React.Component {
  ...
  handleEvent = async event => {
    if (
      ...
      event.target.className !== "menubutton"
    ) {
    ...
    return (
      <div id="popout-menu" className={visibility}>
        <button
          ...
          onClick={() => this.props.history.push("tenantworkorderview")}
        >
          View Work Orders
        </button>
        <button
          className="menubutton"
          onClick={() => this.props.history.push("tenantpayment")}
        >
          Payment
        </button>
        <button
          className="menubutton"
          onClick={() => this.props.history.push("tenantformsubmission")}
        >
          Form Submission
        </button>
